...
Creating suffix array using "Karkkainen Sanders - Skew" algorithm.
Getting last column from suffix array.

Getting the original string back  from last column of SCP
using count sort.
...
int main(int argc, char **argv)
{
    ...
    if(strcmp(str,recvorg) == 0)
        printf("Original and recovered string are same \n");
    else
        printf("Original and recovered string are not same \n");
